...
public class TeamEntityFactory {
    ...
    private org.amhzing.clusterview.app.infra.jpa.mapping.Location convertLocation(final org.amhzing.clusterview.app.domain.model.Location location) {
        return org.amhzing.clusterview.app.infra.jpa.mapping.Location.create(location.coordX(), location.coordY());
    }
    ...
    private org.amhzing.clusterview.app.infra.jpa.mapping.Name convertName(final org.amhzing.clusterview.app.domain.model.Name name) {
        ...
        return org.amhzing.clusterview.app.infra.jpa.mapping.Name.create(firstName == null ? "" : firstName.value(),
