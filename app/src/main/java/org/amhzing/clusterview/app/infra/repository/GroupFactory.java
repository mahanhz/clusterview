...
public final class GroupFactory {
    ...
    private static org.amhzing.clusterview.app.domain.model.Location convertLocation(final org.amhzing.clusterview.app.infra.jpa.mapping.Location location) {
    ...
    private static org.amhzing.clusterview.app.domain.model.Name convertName(final org.amhzing.clusterview.app.infra.jpa.mapping.Name name) {
