...
public class TeamEntityFactory {
    ...
    private org.amhzing.clusterview.backend.infra.jpa.mapping.Location convertLocation(final org.amhzing.clusterview.backend.domain.model.Location location) {
        return org.amhzing.clusterview.backend.infra.jpa.mapping.Location.create(location.coordX(), location.coordY());
    }
    ...
    private org.amhzing.clusterview.backend.infra.jpa.mapping.Name convertName(final org.amhzing.clusterview.backend.domain.model.Name name) {
        ...
        return org.amhzing.clusterview.backend.infra.jpa.mapping.Name.create(firstName == null ? "" : firstName.value(),
