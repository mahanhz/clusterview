...
import org.amhzing.clusterview.api.user.CountryDTO;
import org.amhzing.clusterview.api.user.RoleDTO;
import org.amhzing.clusterview.api.user.UserDTO;
import org.amhzing.clusterview.api.user.UsersDTO;
import org.amhzing.clusterview.domain.Country;
import org.amhzing.clusterview.domain.user.Role;
import org.amhzing.clusterview.domain.user.User;

import java.util.List;
import java.util.stream.Collectors;

import static org.amhzing.clusterview.controller.util.NameDtoFactory.convertName;
