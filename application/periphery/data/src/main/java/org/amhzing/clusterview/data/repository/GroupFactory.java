...
public final class GroupFactory {
    ...
    private static org.amhzing.clusterview.core.domain.Location convertLocation(final org.amhzing.clusterview.data.jpa.entity.Location location) {
    ...
    private static org.amhzing.clusterview.core.domain.Name convertName(final org.amhzing.clusterview.data.jpa.entity.Name name) {
