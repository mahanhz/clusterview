...
public class TeamEntityFactory {
    ...
    private org.amhzing.clusterview.jpa.entity.Location convertLocation(final org.amhzing.clusterview.domain.Location location) {
        return org.amhzing.clusterview.jpa.entity.Location.create(location.coordX(), location.coordY());
    }
    ...
    private org.amhzing.clusterview.jpa.entity.Name convertName(final org.amhzing.clusterview.domain.Name name) {
        ...
        return org.amhzing.clusterview.jpa.entity.Name.create(firstName == null ? "" : firstName.value(),
