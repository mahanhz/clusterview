INSERT INTO ROLE(id, version, name) VALUES(1, 0, 'ROLE_USER');
INSERT INTO ROLE(id, version, name) VALUES(2, 0, 'ROLE_ADMIN');
INSERT INTO ROLE(id, version, name) VALUES(3, 0, 'ROLE_SUPER_ADMIN');
INSERT INTO ROLE(id, version, name) VALUES(4, 0, 'ROLE_ADMIN_SE_ALL');

-- CENTRAL
INSERT INTO ROLE(id, version, name) VALUES(5, 0, 'ROLE_ADMIN_SE_STOCKHOLM');
INSERT INTO ROLE(id, version, name) VALUES(6, 0, 'ROLE_ADMIN_SE_UPPSALA');
INSERT INTO ROLE(id, version, name) VALUES(7, 0, 'ROLE_ADMIN_SE_MALARDALEN');
INSERT INTO ROLE(id, version, name) VALUES(8, 0, 'ROLE_ADMIN_SE_GAVLEBORG');
INSERT INTO ROLE(id, version, name) VALUES(9, 0, 'ROLE_ADMIN_SE_DALARNA');
INSERT INTO ROLE(id, version, name) VALUES(10, 0, 'ROLE_ADMIN_SE_VARMLAND');
INSERT INTO ROLE(id, version, name) VALUES(11, 0, 'ROLE_ADMIN_SE_GOTLAND');

-- NORTHERN
INSERT INTO ROLE(id, version, name) VALUES(12, 0, 'ROLE_ADMIN_SE_NORRBOTTEN');
INSERT INTO ROLE(id, version, name) VALUES(13, 0, 'ROLE_ADMIN_SE_VASTERBOTTEN');
INSERT INTO ROLE(id, version, name) VALUES(14, 0, 'ROLE_ADMIN_SE_JAMTLAND');
INSERT INTO ROLE(id, version, name) VALUES(15, 0, 'ROLE_ADMIN_SE_VASTERNORRLAND');

-- SOUTHERN
INSERT INTO ROLE(id, version, name) VALUES(16, 0, 'ROLE_ADMIN_SE_VASTRAGOTALAND');
INSERT INTO ROLE(id, version, name) VALUES(17, 0, 'ROLE_ADMIN_SE_OSTERGOTLAND');
INSERT INTO ROLE(id, version, name) VALUES(18, 0, 'ROLE_ADMIN_SE_KALMARLAN');
INSERT INTO ROLE(id, version, name) VALUES(19, 0, 'ROLE_ADMIN_SE_JONKOPING');
INSERT INTO ROLE(id, version, name) VALUES(20, 0, 'ROLE_ADMIN_SE_HALLAND');
INSERT INTO ROLE(id, version, name) VALUES(21, 0, 'ROLE_ADMIN_SE_KRONOBERG');
INSERT INTO ROLE(id, version, name) VALUES(22, 0, 'ROLE_ADMIN_SE_BLEKINGE');
INSERT INTO ROLE(id, version, name) VALUES(23, 0, 'ROLE_ADMIN_SE_SKANE');
...
INSERT INTO COURSE VALUES('9', 0, 'Book 9');
...
INSERT INTO CLUSTERS_COURSES  VALUES('stockholm', 10, '9');
INSERT INTO CLUSTERS_COURSES  VALUES('stockholm', 5, '10');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 10, '1');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 9, '2');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 8, '3');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 7, '4');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 2, '5');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 6, '6');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 5, '7');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 3, '8');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 2, '9');
INSERT INTO CLUSTERS_COURSES  VALUES('uppsala', 1, '10');
