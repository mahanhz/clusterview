...
import static org.amhzing.clusterview.helper.AuthenticationHelper.AUTHENTICATION_COUNTRY;
import static org.amhzing.clusterview.helper.AuthenticationHelper.userDetails;
...
public class WebSecurityTest {
    ...
    public void should_allow_when_user_belongs_to_country() throws Exception {
        ...
        final boolean result = webSecurity.checkCountry(authentication, AUTHENTICATION_COUNTRY);
